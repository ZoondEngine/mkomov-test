    ...
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <a href="#" class="flex items-center">
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">MKOMOV TEST</span>
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                    <li>
                        <Link :href="route('index')" :class="linkClass('index')">Главная</Link>
                    </li>
                    <li>
                        <Link :href="route('blog.all')" :class="linkClass('blog.all')">Список статей</Link>
                    </li>
                </ul>
            </div>
        </div>
